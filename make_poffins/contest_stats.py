...
f"  {BOLD}{outline}{'-'* amt}{RESET                                                                                                                                                                                                          }{FLAVOR_COLORS['Dry'   ]}      \###|     |###/  {RESET}   \n"  # noqa ES501
f"  {BOLD}{outline}| {FLAVOR_COLORS['Spicy' ]}{'(Spicy)'  :<8}{RESET} ->  {BOLD}{FLAVOR_COLORS['Spicy' ]}{'Coolness'  :<14}{RESET}:{bad_red if self.coolness   < 255 else FLAVOR_COLORS['Bitter']}{self.coolness  :>4} {BOLD}{outline}|{RESET}{FLAVOR_COLORS['Dry'   ]}       `##|_____|##'   {RESET}   \n"  # noqa ES501
